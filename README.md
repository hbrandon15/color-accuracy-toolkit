...
### Sony Alpha 7 IV
- **Settings:** Manual exposure (1/200 shutter, f/5.6, ISO 200), no in-camera corrections, Picture Profile set to neutral/flat, White Balance set to 5500K Daylight, lossless compressed RAW
